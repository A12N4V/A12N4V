<div align="center">
  ...
  <img src="assets/header_art.jpg" height="10%" width="100%" alt="AI art is good" style="border-radius: 6px; margin: 12px 0;" /><br>
...
<table width="100%" border="0" bgcolor="#000000" style="background-color: #000000; border-collapse: collapse;">
  <tr bgcolor="#000000">
    <td width="33.33%" align="center" valign="top" bgcolor="#000000" style="background-color: #000000; border: 1px solid #1a1a1a; padding: 14px;">
      ...
      <strong style="color: #ffffff; font-size: 12px;">SYNAPTIC CONNECTIVITY</strong><br>
      <sub style="color: #888888; font-size: 10px;">NEURAL TRANSMISSION</sub>
      <p style="color: #aaaaaa; font-size: 11px; line-height: 1.45; text-align: left; margin-top: 8px;">
    ...
    <td width="33.33%" align="center" valign="top" bgcolor="#000000" style="background-color: #000000; border: 1px solid #1a1a1a; padding: 14px;">
      ...
      <strong style="color: #ffffff; font-size: 12px;">PURKINJE CELL</strong><br>
      <sub style="color: #888888; font-size: 10px;">SANTIAGO RAMÓN Y CAJAL</sub>
      <p style="color: #aaaaaa; font-size: 11px; line-height: 1.45; text-align: left; margin-top: 8px;">
    ...
    <td width="33.33%" align="center" valign="top" bgcolor="#000000" style="background-color: #000000; border: 1px solid #1a1a1a; padding: 14px;">
      ...
      <strong style="color: #ffffff; font-size: 12px;">CORTICAL ARCHITECTURE</strong><br>
      <sub style="color: #888888; font-size: 10px;">WHOLE-ORGANISM INTEGRATION</sub>
      <p style="color: #aaaaaa; font-size: 11px; line-height: 1.45; text-align: left; margin-top: 8px;">
